    ...
    override fun onUpdate(
        ...
        for (appWidgetId in appWidgetIds) {
            val views = RemoteViews(context.packageName, R.layout.tasks_widget).apply {
                // RemoteViewsService для списка задач
                ...
                // Обработчик кликов: вместо HomeWidgetBackgroundIntent
                // используем наш нативный TasksWidgetActionReceiver
                val clickIntent = TasksWidgetActionReceiver.createPendingIntent(context)
